...
import { openDeleteAccountModal } from '../../redux/actions/users'
  ...
  return (
    <>
      <p>
        ...
        subscription to the premium plan at the time you delete your account,
        your subscription will be terminated, and you will not recieve a refund
        for any portion of the unused subscription period.
      </p>
      <div className='mt-3'>
